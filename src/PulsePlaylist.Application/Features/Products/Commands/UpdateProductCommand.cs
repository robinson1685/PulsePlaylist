...
using PulsePlaylist.Application.Features.Products.EventHandlers;
using PulsePlaylist.Application.Pipeline;

namespace PulsePlaylist.Application.Features.Products.Commands;

...
using System;
namespace PulsePlaylist.Api.Client.Account.Signup
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::PulsePlaylist.Api.Client.Account.Signup.SignupRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        public async Task PostAsync(global::PulsePlaylist.Api.Client.Models.SignupRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="body">The request body</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        public RequestInformation ToPostRequestInformation(global::PulsePlaylist.Api.Client.Models.SignupRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        {
            _ = body ?? throw new ArgumentNullException(nameof(body));
        ...
        /// </summary>
        /// <returns>A <see cref="global::PulsePlaylist.Api.Client.Account.Signup.SignupRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::PulsePlaylist.Api.Client.Account.Signup.SignupRequestBuilder WithUrl(string rawUrl)
        {
            return new global::PulsePlaylist.Api.Client.Account.Signup.SignupRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>

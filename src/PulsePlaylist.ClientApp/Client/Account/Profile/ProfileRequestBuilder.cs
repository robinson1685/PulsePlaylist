...
using System;
namespace PulsePlaylist.Api.Client.Account.Profile
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::PulsePlaylist.Api.Client.Account.Profile.ProfileRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        public async Task<global::PulsePlaylist.Api.Client.Models.ProfileResponse> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::PulsePlaylist.Api.Client.Models.ProfileResponse>(requestInfo, global::PulsePlaylist.Api.Client.Models.ProfileResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        ...
        public async Task<global::PulsePlaylist.Api.Client.Models.ProfileResponse> PostAsync(global::PulsePlaylist.Api.Client.Models.ProfileRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="body">The request body</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        public RequestInformation ToPostRequestInformation(global::PulsePlaylist.Api.Client.Models.ProfileRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        {
            _ = body ?? throw new ArgumentNullException(nameof(body));
        ...
        /// </summary>
        /// <returns>A <see cref="global::PulsePlaylist.Api.Client.Account.Profile.ProfileRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::PulsePlaylist.Api.Client.Account.Profile.ProfileRequestBuilder WithUrl(string rawUrl)
        {
            return new global::PulsePlaylist.Api.Client.Account.Profile.ProfileRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>

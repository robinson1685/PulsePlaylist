...
using System;
namespace PulsePlaylist.Api.Client.FileManagement.Upload
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::PulsePlaylist.Api.Client.FileManagement.Upload.UploadRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::PulsePlaylist.Api.Client.FileManagement.Upload.UploadRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::PulsePlaylist.Api.Client.FileManagement.Upload.UploadRequestBuilder WithUrl(string rawUrl)
        {
            return new global::PulsePlaylist.Api.Client.FileManagement.Upload.UploadRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>

...
using PulsePlaylist.Application.Common.Models;
using PulsePlaylist.Application.Features.Products.Commands;
using PulsePlaylist.Application.Features.Products.DTOs;
using PulsePlaylist.Application.Features.Products.Queries;
using Mediator;
using Microsoft.AspNetCore.Mvc;
using static PulsePlaylist.Api.Endpoints.FileUploadEndpointRegistrar;

namespace PulsePlaylist.Api.Endpoints;
